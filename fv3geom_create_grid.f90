...
use fv3geom_constants_mod,     only: kind_real, pi, todeg
...
!  do j = 1,npy-1
!    do i = 1,npx-1
!      print*, "PROJ OUT: ", int(i-1,2), ",", int(j-1,2), ",", int(t-1,2), "|", &
!real(grid_global(i,j,1,t),4)*todeg, real(grid_global(i,j,2,t),4)*todeg
!    enddo
!  enddo
!enddo
...
do n = 1, nregions
  print*, ' '
  print*, 'Tile: ', n
  print*, "1,1    : ", todeg*grid_global(1    ,1    ,1,n), todeg*grid_global(1    ,1    ,2,n)
  print*, "1,  jsc: ", todeg*grid_global(1    ,npy-1,1,n), todeg*grid_global(1    ,npy-1,2,n)
  print*, "isc,1  : ", todeg*grid_global(npx-1,1    ,1,n), todeg*grid_global(npx-1,1    ,2,n)
  print*, "iec,jec: ", todeg*grid_global(npx-1,npy-1,1,n), todeg*grid_global(npx-1,npy-1,2,n)
enddo
